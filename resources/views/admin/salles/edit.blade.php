                ...
                <div>
                    ...
                    <div class="relative">
                        <select name="localisation"
                            ...
                            <option value="Bloc A, Etage 2" {{ old('localisation', $salle->localisation) == 'Bloc A, Etage 2' ? 'selected' : '' }}>Bloc A, Etage 2</option>
                            <option value="Bâtiment principal, 1er étage" {{ old('localisation', $salle->localisation) == 'Bâtiment principal, 1er étage' ? 'selected' : '' }}>Bâtiment principal, 1er étage</option>
                            <option value="Bloc B, Etage 1" {{ old('localisation', $salle->localisation) == 'Bloc B, Etage 1' ? 'selected' : '' }}>Bloc B, Etage 1</option>
                            <option value="Bâtiment principal, 2ème étage" {{ old('localisation', $salle->localisation) == 'Bâtiment principal, 2ème étage' ? 'selected' : '' }}>Bâtiment principal, 2ème étage</option>
                        </select>
                    ...
                    <div class="relative">
                        <select name="responsable_id"
                            ...
                            @foreach($responsables as $resp)
                                <option value="{{ $resp->id }}" {{ old('responsable_id', $salle->responsable_id) == $resp->id ? 'selected' : '' }}>
