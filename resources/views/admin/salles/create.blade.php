...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Ajouter une salle</h1>
    </div>

    <div class="bg-white rounded-2xl shadow border border-gray-100 p-6">
        <form method="POST" action="{{ route('admin.salles.store') }}" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="number" name="capacite" value="{{ old('capacite', 1) }}" min="1" required
                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none text-sm">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none text-sm resize-none"
                    placeholder="Décrivez la salle...">{{ old('description') }}</textarea>
            </div>
