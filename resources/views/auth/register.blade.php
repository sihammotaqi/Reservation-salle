...
<head>
    ...
    <title>Créer un compte - SallePro</title>
...
<body class="bg-gray-50 text-gray-900 font-sans antialiased min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md px-6 py-12 bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 shadow-green-900/5 my-8">
        
        <div class="text-center mb-10 border-b border-gray-100 pb-8">
            <h1 class="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-green-500 mb-2">Rejoignez-nous</h1>
            <p class="text-gray-500 font-medium">Créez votre compte pour commencer.</p>
        </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                        class="block w-full pl-10 pr-10 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 outline-none text-gray-900 shadow-sm"
                        placeholder="••••••••">
                    <button type="button" onclick="togglePassword('password_confirmation', 'eye-icon-confirm')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-green-500 focus:outline-none transition-colors">
